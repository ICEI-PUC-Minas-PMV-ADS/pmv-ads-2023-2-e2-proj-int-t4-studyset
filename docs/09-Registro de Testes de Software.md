...
| Procedimentos (passo à passo) | 1) Acessar a página de cadastro a partir da homepage do site <br>
2) Preencher os dados do formulário seguindo as respectivas validações <br>
